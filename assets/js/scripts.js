    ...
    (Neela = {
        ...
        navigation: function () {
            u(".nav li a").on("click", function (e) {
                ...
                "#" === t.attr("href").charAt(0) && u(t.attr("href")).length
                    ? (e.preventDefault(),
                      "#hero" !== t.attr("href") && null !== u(t.attr("href")).offset() && (a = u(t.attr("href")).offset().top - 55),
                      u("html, body")
                          .stop()
                          .animate({ scrollTop: a }, 1500, "easeOutExpo", function () {
                              t.blur();
                          }))
                    : window.open(t.attr("href"), "_self");
            }),
                void 0 !== window.Waypoint && new Waypoint.Sticky({ element: u(".nav-section"), offset: -1 }),
                ...
                u(window).on("load", function () {
                    ...
                    "" !== e &&
                        ...
                        u("html, body")
                            .stop()
                            .animate({ scrollTop: u("#" + e).offset().top - 65 }, 1500, "easeInOutExpo")),
                        void 0 !== window.Waypoint && new Waypoint.Sticky({ element: u(".nav-section") });
                });
        },
        createMobileMenu: function (e) {
            ...
            null !== e && (e = u(window).innerWidth()),
                e <= 975 &&
                    !t.mobMenuFlag &&
                    (u("body").prepend('<nav class="nav-mobile"><i class="fa fa-times"></i><h2>' + t.mobileMenuTitle + "</h2><ul></ul></nav>"),
                    u(".nav-mobile > ul").html(u(".nav").html()),
                    u(".nav-mobile b, .nav-mobile .nav-logo").remove(),
                    u(".nav-mobile ul.dropdown-menu").removeClass().addClass("dropdown-mobile"),
                    u(".navbar > a.btn").length &&
                        (u(".navbar > a.btn").each(function () {
                            u(".nav-mobile").append(u(this).clone());
                        }),
                        u(".nav-mobile > a.btn").removeClass("btn-light").addClass("btn-primary btn-sm")),
                    (n = u(".nav-mobile")),
                    ...
                    u(".nav-mobile li a").on("click", function (e) {
                        var t = u(this),
                            a = 0;
                        "#hero" !== t.attr("href") && (a = u(t.attr("href")).offset().top - 65),
                            u("html, body")
                                .stop()
                                .animate({ scrollTop: a }, 1500, "easeInOutExpo", function () {
                                    t.blur();
                                }),
                            o.removeClass("open"),
                            n.removeClass("open"),
            ...
            this.heroFullScreen &&
                ...
                u(window).resize(function () {
                    ...
                    t < 0 && !Number.isNaN(t) && (a += t + e),
                        ...
                        0 < n && u(".v-center").length && u("#hero >.container").css({ "margin-top": n / 2 + o + "px" }),
                        u("#hero").css({ minHeight: u(window).innerHeight() + "px" });
                }));
        },
        bgImageGrid: function () {
            u("#freewall").length &&
                (u("#freewall .item").each(function () {
                    var e = u(this);
                    e.width(Math.floor(260 + 200 * Math.random())), e.css({ "background-image": "url(" + u(">img", e).attr("src") + ")" }), u(">img", e).remove();
                }),
        ...
        googleMap: function () {
            ...
            (/^\d|\.|-$/.test(l.mapInitialLatitude) && /^\d|\.|-$/.test(l.mapInitialLongitude)) || ((l.mapInitialLatitude = l.mapMarkers[0].latitude), (l.mapInitialLongitude = l.mapMarkers[0].longitude)),
                (t = new google.maps.LatLng(l.mapInitialLatitude, l.mapInitialLongitude)),
                l.useDefaultMapStyle ||
                    (c = [
                        { stylers: [{ hue: l.mapColor }, { saturation: -75 }, { lightness: 5 }] },
                        ...
                        { featureType: "road", elementType: "geometry", stylers: [{ hue: l.mapColor }, { saturation: -100 }, { lightness: 0 }] },
                        { featureType: "road.highway", elementType: "geometry", stylers: [{ hue: l.mapColor }, { saturation: 5 }, { lightness: 5 }] },
                        ...
                        { featureType: "transit", elementType: "geometry", stylers: [{ hue: l.mapColor }, { saturation: 30 }, { lightness: -30 }] },
                    ]),
                ...
                l.rtlFlag && ((i = google.maps.ControlPosition.LEFT_CENTER), (r = google.maps.ControlPosition.LEFT_BOTTOM), (c = google.maps.ControlPosition.LEFT_TOP)),
                (a = {
                    center: t,
                ...
                u(".gmap").each(function () {
                    for (
                        n = u(this).attr("id"),
                            (s = new google.maps.Map(document.getElementById(n), a)).mapTypes.set("map_style", e),
                            ...
                            o = function (e) {
                                var t = e.latitude,
                                    ...
                                    n = e.icon,
                                    e = e.infoWindow,
                                    o = new google.maps.InfoWindow({ content: '<div class="infoWindow">' + e + "</div>" }),
                                    i = new RichMarker({
        ...
        createBackgroundSlideshow: function () {
            u(".bg-slideshow").length && this.slidehowImages.length && u(".bg-slideshow").zoomSlider({ src: this.slidehowImages, bullets: !1, speed: 1e4, switchSpeed: 1e3, interval: 6e3 });
        },
        ...
        createOwlSliders: function () {
            u(".timeline-gallery").length && u(".timeline-gallery").owlCarousel({ nav: !0, dots: !1, responsive: { 0: { items: 1 } }, rtl: this.rtlFlag }),
                u(".testimonials").length && u(".testimonials").owlCarousel({ nav: !1, dots: !0, responsive: { 0: { items: 1 } }, rtl: this.rtlFlag });
        },
            ...
            u(".gallery-scroller").length &&
                (u(".gallery-right").on("click", function () {
                    return (
                        !t &&
                        ((t = !0),
                        void e.animate({ scrollLeft: e.scrollLeft() + 380 }, function () {
                            t = !1;
                        }))
                    );
                }),
                ...
                u(document).ready(function () {
                    u(".gallery-scroller").niceScroll({ cursorcolor: "#fff", cursorwidth: "0px", background: "#fff", cursorborder: "0px solid #1F2326", zindex: "999", autohidemode: !1, enablemousewheel: !1, touchbehavior: !0 });
                }));
        },
        countdown: function () {
            var o,
            ...
            u(".countdown").length &&
                ((o = function (e, t, a) {
                    ...
                    (n = Math.floor((o / 864e5) * 1)),
                        ...
                        (o = Math.floor(((((o % 864e5) % 36e5) % 6e4) / 1e3) * 1)),
                        u(".days > div", t).html(n),
        ...
        parallaxBg: function () {
            ...
            !u.browser.mobile && 992 < u(window).innerWidth()
                ...
                : u(".parallax-background").css({ "background-position": "50% 50%", "background-size": "cover", "background-attachment": "scroll" });
        },
        ...
        resizeVideos: function () {
            ...
            e.each(function () {
                ...
                (t < 0.3 || 0.8 < t || Number.isNaN(t)) && (t = 0.559), e.attr("data-aspectRatio", t).removeAttr("height").removeAttr("width");
            }),
                u(window)
                    .resize(function () {
                        e.each(function () {
                ...
                return (
                    ...
                    s.each(function () {
                        ...
                        "hidden" === e.attr("type")
                            ? e.hasClass("subject")
                                ? (c += "&subject=" + n(e.val()))
                                : e.hasClass("fromName") || e.hasClass("fromname")
                                ? (c += "&fromname=" + n(e.val()))
                                : e.hasClass("fromEmail") || e.hasClass("fromemail")
                                ? (c += "&fromemail=" + n(e.val()))
                                : (e.hasClass("emailTo") || e.hasClass("emailto")) && (c += "&emailto=" + n(e.val()))
                            : ("checkbox" === e.attr("type") && 1 === e.parents("fieldset").length && e.parents("fieldset").hasClass("required")) ||
                              (e.is("fieldset") && e.hasClass("required") && 0 === u("#" + e.attr("id") + " input:checkbox:checked").length
                                  ? (u("input", e).addClass("is-invalid"), (d = !0))
                                  : (e.hasClass("required") && "checkbox" === e.attr("type") && !u("input[id='" + e.attr("id") + "']").is(":checked")) ||
                                    (e.hasClass("required") && "" === e.val() && "checkbox" !== e.attr("type") && !e.is("fieldset")) ||
                                    (e.hasClass("required") && "radio" === e.attr("type") && !u("input[name='" + e.attr("name") + "']").is(":checked")) ||
                                    ("email" === e.attr("type") && "" !== e.val() && !1 === l.test(e.val()))
                                  ...
                                  : "g-recaptcha-response" !== e.attr("id") &&
                                    ...
                                    e.hasClass("subject")
                                        ? ((c += "&subject=" + n(e.val())), (c += "&subject_label=" + n(e.attr("name"))))
                                        : e.hasClass("fromName") || e.hasClass("fromname")
                                        ? ((c += "&fromname=" + n(e.val())), (c += "&fromname_label=" + n(e.attr("name"))))
                                        : e.hasClass("fromEmail") || e.hasClass("fromemail")
                                        ? ((c += "&fromemail=" + n(e.val())), (c += "&fromemail_label=" + n(e.attr("name"))))
                                        : ("radio" === e.attr("type")
                                              ? u("input[id='" + e.attr("id") + "']").is(":checked") &&
                                                ((c += "&field" + r + "_label=" + n(e.attr("name"))), (c += "&field" + r + "_value=" + n(u.trim(u("label[for='" + e.attr("id") + "']").text()))))
                                              : e.is("fieldset")
                                              ? ((c += "&field" + r + "_label=" + n(e.attr("name"))),
                                                u("#" + e.attr("id") + " input:checkbox:checked").each(function (e) {
                                                    0 === e
                                                        ? ((c += "&field" + r + "_value="), (c += n(u.trim(u("label[for='" + u(this).attr("id") + "']").text()))))
                                                        : (c += ", " + n(u.trim(u("label[for='" + u(this).attr("id") + "']").text())));
                                                }))
                                              : ((c += "&field" + r + "_label=" + n(e.attr("name"))), (c += "&field" + r + "_value=" + n(e.val()))),
                                          (r += 1))));
                    }),
                    (c += "&len=" + r),
                    u(".g-recaptcha").length && (c += "&recaptcha=" + grecaptcha.getResponse()),
                    (t = function () {
                        u(".form_status_message").html(
                            '<div class="alert alert-success alert-dismissible fade show" role="alert">' + m.contactFormSuccessMsg + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>'
                        );
                    }),
                    (a = function () {
                    ...
                    d || m.sendingMail
                        ? m.showError()
                        : ((m.sendingMail = !0),
                          o.append('<i class="fas fa-spinner fa-spin after"></i>'),
                          o.addClass("disabled"),
                          u.ajax({
                              type: "POST",
                              url: "contact.php",
        ...
        showError: function (e = "") {
            "" === e && (e = this.contactFormErrorMsg),
                u(".form_status_message").html('<div class="alert alert-danger alert-dismissible fade show" role="alert">' + e + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
        },
        objEvents: function () {
            u(".btn").each(function () {
                var e = u(this),
                ...
                u(".element-v2").length &&
                    u(".element-v2").each(function () {
                        ...
                        e.css({ "background-image": "url(" + u(">img", e).attr("src") + ")" }), u(">img", e).hide();
                    }),
                u(".overflow-image").length &&
                    u(".overflow-image").each(function () {
                        var e = u(this);
                        e.css({ "background-image": "url(" + u(">img", e).attr("src") + ")" });
                    }),
                u(".progress").length &&
                    u(".progress").waypoint(
                        function () {
                ...
                u("[data-animation-delay]").each(function () {
                    ...
                    e.addClass("animate-" + o),
                        u(document).ready(function () {
                            t + a >= e.offset().top &&
                                (Number.isNaN(n) || 0 === n
                                    ? e.removeClass("animate-" + o).addClass("animation-" + o)
                                    : setTimeout(function () {
